!(function (t, e, i, n) {
    ...
    function C(t, e) {
      for (
        var i, s, r = e[0].toUpperCase() + e.slice(1), o = 0;
        o < dt.length;
    ...
    function S(t, e) {
      ...
      if (e.eventType != Mt && (s > bt || i.velocity === n)) {
        ...
        (r = i.velocity), (o = i.velocityX), (a = i.velocityY), (l = i.direction);
    ...
    function V(t, e) {
      t & Pt
        ? ((this.primaryTouch = e.changedPointers[0].identifier), U.call(this, e))
        : t & (Rt | Mt) && U.call(this, e);
    }
    function U(t) {
    ...
    function J(t) {
      (this.options = Tt({}, this.defaults, t || {})),
        (this.id = E()),
        (this.manager = null),
    ...
    function lt(t, e) {
      return (
        (e = e || {}),
        (e.recognizers = u(e.recognizers, lt.defaults.preset)),
        new ct(t, e)
      );
    }
    function ct(t, e) {
      (this.options = Tt({}, lt.defaults, e || {})),
    ...
    var Vt = { mousedown: Pt, mousemove: Ot, mouseup: Rt },
      Ut = "mousedown",
    ...
    var Kt = { touchstart: Pt, touchmove: Ot, touchend: Rt, touchcancel: Mt },
      Qt = "touchstart",
    ...
    l(q, I, {
      handler: function Se(t) {
        ...
        if ((e === Pt && (this.started = !0), this.started)) {
          ...
          e & (Rt | Mt) && i[0].length - i[1].length === 0 && (this.started = !1),
            this.callback(this.manager, e, {
              pointers: i[0],
              changedPointers: i[1],
              pointerType: At,
    ...
    var ee = { touchstart: Pt, touchmove: Ot, touchend: Rt, touchcancel: Mt },
    ...
    (J.prototype = {
      ...
      dropRecognizeWith: function (t) {
        return r(t, "dropRecognizeWith", this)
          ? this
          : ((t = tt(t, this)), delete this.simultaneous[t.id], this);
      },
      ...
      recognize: function (t) {
        var e = Tt({}, t);
        return h(this.options.enable, [this, e])
          ? (this.state & (Te | ye | Ce) && (this.state = fe),
      ...
      l(it, et, {
        ...
        attrTest: function (t) {
          return (
            et.prototype.attrTest.call(this, t) &&
            (this.state & ve || (!(this.state & ve) && this.directionTest(t)))
          );
        },
        emit: function (t) {
      ...
      l(nt, et, {
        ...
        attrTest: function (t) {
          return (
            ...
            (Math.abs(t.scale - 1) > this.options.threshold || this.state & ve)
          );
        },
        emit: function (t) {
          if (1 !== t.scale) {
      ...
      l(st, J, {
        ...
        process: function (t) {
          ...
          if (((this._input = t), !n || !i || (t.eventType & (Rt | Mt) && !r)))
            this.reset();
      ...
      l(rt, et, {
        ...
        attrTest: function (t) {
          return (
            this._super.attrTest.call(this, t) &&
            (Math.abs(t.rotation) > this.options.threshold || this.state & ve)
          );
        },
      }),
      l(ot, et, {
          ...
          for (var r = 0; r < n.length; )
            (i = n[r]),
              e.stopped === xe || (s && i != s && !i.canRecognizeWith(s))
                ? i.reset()
                : i.recognize(t),
              !s && i.state & (ve | me | ge) && (s = e.curRecognizer = i),
              r++;
        }
      },
      get: function (t) {
